...
{block name="page_content"}
  ...
  <div class="alert alert-warning">
    <p>
      <p>{l s='You have to log in to create a quotation.' mod='opartdevis'}</p>
      <a href="{$link->getPageLink('authentication', true, null)|escape:'htmlall':'UTF-8':'UTF-8'}" class="btn btn-primary button button-medium">
  ...
  {if $OPARTDEVIS_SIMPLE_FORM == 1}
    <p>
      ...
      <a href="{$link->getModuleLink('opartdevis', 'simplequotation',[])|escape:'htmlall':'UTF-8'}" class="btn btn-link px-0 button button-small">
