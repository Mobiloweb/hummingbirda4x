...
|| $quotation->status == OpartQuotation::EXPIRED
  ...
  <div class="alert alert-warning">
    ...
    <p>
      ...
      <a href="{$link->getModuleLink('opartdevis', 'listquotation', ['newcart' => true])|escape:'htmlall':'UTF-8'}" class="button btn btn-link button-small">
                <span>
...
{if ($quotation->status == OpartQuotation::NOT_VALIDATED)}
  <div class="alert alert-info">
    ...
    <p>
      ...
      <a href="{$link->getModuleLink('opartdevis', 'listquotation', ['newcart' => true])|escape:'htmlall':'UTF-8'}" class="btn btn-link button button-small">
                <span>
                    {l s='Create a new cart' mod='opartdevis'}
                </span>
      </a>
