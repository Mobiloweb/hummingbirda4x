...
<section id="order-summary-content" class="order__summary">
  ...
  <div class="order__summary__addresses mb-4">
    <p class="h5 mb-3">
      ...
      <span class="btn step-edit step-to-addresses fs-6 text-gray js-edit-addresses" data-step="checkout-addresses-step">{include file="_svg/edit.svg"} {l s='edit' d='Shop.Theme.Actions'}</span>
    </p>
  ...
  {if !$cart.is_virtual}
    <p class="h5 mb-3">
      ...
      <span class="btn step-edit step-to-addresses fs-6 text-gray js-edit-shipping" data-step="checkout-delivery-step">{include file="_svg/edit.svg"} {l s='edit' d='Shop.Theme.Actions'}</span>
    </p>
